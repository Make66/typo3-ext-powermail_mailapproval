...
namespace Taketool\PowermailMailapproval\Domain\Repository;
 ...
 */
class MyMailRepository extends \In2code\Powermail\Domain\Repository\MailRepository
{
    use SignalTrait;
    ...
    public function findListBySettings(array $settings, array $piVars): QueryResultInterface
    {
        ...
        // FILTER: include only approved records
        if ((int)($searchSettings['staticPluginsVariables']['filter']['approved'] ?? 0) > 0) {
            $and[] = $query->equals('approved', 1);
        }
